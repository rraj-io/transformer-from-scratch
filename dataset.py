...
class BilingualDataset(Dataset):
    ...
    def __getitem__(self, inddex: Any) -> Any:
        ...
        encoder_input = torch.cat(
            [
                ...
                self.eos_token,
                torch.tensor([self.pad_token] * enc_num_padding_tokens, dtype=int64)
            ]
        )
        ...
        decoder_input = torch.cat(
            [
                ...
                torch.tensor([self.pad_token] * dec_num_padding_tokens, dtype=int64)
            ]
        )
